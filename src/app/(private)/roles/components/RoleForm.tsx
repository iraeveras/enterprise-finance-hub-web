...
const modules: { id: ModuleID; name: string }[] = [
    ...
    { id: "costcenterplanitems", name: "Itens de Plano de Centro de Custo" },
    { id: "expensetypes", name: "Tipos de Despesas Plano de Centro de Custo" },
    { id: "expensesubtypes", name: "Subipos de Despesas Plano de Centro de Custo" },
